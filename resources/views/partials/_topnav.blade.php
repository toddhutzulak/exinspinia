<div class="row">
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right" style="line-height: 1;">
            ...
            <li><a class="count-info white trans-scale-sm" href="#" ><i class="fa fa-bell"></i><span class="label label-danger">3</span></a></li>
            <li><a class="white" href="#" ><i class="fa fa-sign-out"></i> Logout</a></li>
        </ul>
    </nav>
</div>
